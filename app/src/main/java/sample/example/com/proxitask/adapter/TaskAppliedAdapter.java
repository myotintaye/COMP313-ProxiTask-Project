...
public class TaskAppliedAdapter extends RecyclerView.Adapter<TaskAppliedAdapter.MyViewHolder> {
...
//        btnCall = (Button) view.findViewById(R.id.btn_call);
    ...
    public TaskAppliedAdapter(Context context, List<Task> taskList){
        this.context = context;
        this.taskList = taskList;
    }

    @Override
    public TaskAppliedAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_tasks_applied, parent, false);

        return new TaskAppliedAdapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(final TaskAppliedAdapter.MyViewHolder holder, int position){
